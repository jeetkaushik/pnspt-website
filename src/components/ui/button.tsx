  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        cta: "bg-primary text-primary-foreground hover:bg-primary-hover hover:shadow-xl hover:-translate-y-1 font-semibold",
        hero: "bg-primary text-primary-foreground hover:bg-primary-hover hover:shadow-2xl hover:-translate-y-1 font-bold text-lg px-8 py-4 rounded-lg",
        nav: "bg-primary text-primary-foreground hover:bg-primary-hover hover:shadow-md font-medium px-6 py-2 rounded-md",
      },
      size: {
